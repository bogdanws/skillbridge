...
export default function Header() {
    return <div className={'relative h-[30vh] md:h-[90vh] border-2 border-gray m-4'}>
        <Image src={header_photo} priority={true} alt="" className={"opacity-50 blur-sm -scale-x-100 w-auto h-full absolute bottom-0 right-0 object-bottom object-contain"} />
