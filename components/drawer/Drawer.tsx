...
export default function Drawer() {
    return <>
        ...
        <div
            className={'h-16 md:h-full w-full md:w-16 z-10 fixed bottom-0 md:left-0 flex flex-row md:flex-col justify-center border-t-2 md:border-r-2 border-primary-950 bg-white rounded'}>
